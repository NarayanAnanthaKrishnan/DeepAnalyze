...
_THEME_INSTRUCTIONS: dict[str, str] = {
    ...
    "aura": (
        "ROLE & AESTHETIC VISION:\n"
        "You are an expert frontend developer specializing in futuristic,\n"
        "high-end immersive web experiences. Build a web UI based on the\n"
        "'ULTRA-FLUID BIOMORPHIC GLASS' theme. Think: the sleek, curving\n"
        "interface of a next-generation AI operating system crossed with the\n"
        "organic, glowing fluidity of deep-sea bioluminescence. Every element\n"
        "should feel alive, smooth, and entirely devoid of sharp angles.\n"
        "\n"
        "COLOR PALETTE & TYPOGRAPHY:\n"
        "- Background: Deep abyss dark mode, using rich obsidian or midnight\n"
        "  blue (#050510 to #0B0C15) as the base.\n"
        "- Accents: Liquid, glowing gradients of electric cyan (#00F0FF),\n"
        "  neon violet (#8A2BE2), and soft magenta (#FF007F) that blend\n"
        "  seamlessly.\n"
        "- Text: Crisp off-white (#E2E8F0) for maximum readability, with\n"
        "  muted lavender-gray for secondary text.\n"
        "- Fonts: Use heavily rounded, ultra-modern geometric sans-serifs\n"
        "  like 'Outfit', 'Plus Jakarta Sans', or 'Poppins'. Headings should\n"
        "  be smooth and tight, while body text remains effortlessly legible\n"
        "  and soft.\n"
        "\n"
        "LAYOUT & ARCHITECTURE:\n"
        "- Layout: Completely abandon rigid, boxy grids. Use floating,\n"
        "  overlapping containers with massive border-radiuses (e.g.,\n"
        "  border-radius: 24px to 50px) to create pill shapes, soft bubbles,\n"
        "  and flowing enclosures.\n"
        "- Spacing should feel airy, infinite, and weightless.\n"
        "- Transitions: Sections must be divided by smooth, sweeping,\n"
        "  asymmetrical SVG curves and waves rather than harsh, straight\n"
        "  horizontal lines.\n"
        "\n"
        "UI COMPONENTS & ASSETS:\n"
        "- Glassmorphism (CRITICAL): Heavy use of frosted glass effects for\n"
        "  all structural cards, navigation bars, and overlays\n"
        "  (backdrop-filter: blur(24px) combined with\n"
        "  background: rgba(255, 255, 255, 0.03)).\n"
        "- Borders: Use delicate, translucent 1px borders\n"
        "  (border: 1px solid rgba(255, 255, 255, 0.1)) to define curved\n"
        "  edges without harshness.\n"
        "- Shadows: Replace standard dark drop shadows with soft, colored,\n"
        "  glowing box-shadows that match the accent gradients, making\n"
        "  elements look like they are hovering and radiating light.\n"
        "- Buttons: Fully rounded, pill-shaped buttons with fluid, pulsing\n"
        "  hover states that expand the glow.\n"
        "\n"
        "TECHNICAL & ACCESSIBILITY CONSTRAINTS:\n"
        "- Ensure all text maintains WCAG AA contrast against dark backgrounds.\n"
        "- Utilize CSS variables to animate gradient positions\n"
        "  (background-position) to simulate gentle, breathing, organic\n"
        "  movement throughout the UI.\n"
        "- Mobile Degradation: Ensure the floating, curved containers stack\n"
        "  smoothly into an elegant, scrolling waterfall of rounded glass\n"
        "  cards on smaller screens without losing their organic shape."
    ),
    "surprise": (
        "SURPRISE ME THEME:\n"
